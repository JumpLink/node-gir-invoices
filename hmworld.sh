...
DAEMON_ARGS="/var/www/jumplink/HMWorld-Website/site/app.js"               # path to your node.js server/app
                                            # NB: don't use ~/ in path

DESC="node.js HMWorld http server"                  # whatever fancy description you like
